...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(ItemCombinationQuestion question) {
        ...
        for (Item item : question.getItems()) {
            for (Association association : item.getConnections()) {
                this.result = this.result + String.format("\n\tItem: %s", association.getItemOne()) + String.format("\tConnects to Item: %s\n", association.getItemTwo());
            }
        }
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        this.result += String.format("\n\tMaximum number of characters is : %s", question.getMaxCharacters()) + "\n";

        this.result = this.result + "\n\tProposed Answer: " + question.getProposedAnswer() + "\n";
