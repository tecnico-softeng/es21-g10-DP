...
public enum ErrorMessage {
    ...
    OPTION_IS_NOT_ORDERED("This option has no order"),
    ...
    NO_EXISTING_CONNECTION("Question does not have any connection between items"),
    ...
    AT_LEAST_TWO_OPTIONS_NEEDED("Item Combination Questions need to have at least two options."),
    AT_LEAST_THREE_SLOTS_NEEDED("Order questions need to have at least 3 used slots."),
    AT_LEAST_TWO_ITEMS_NEEDED("Questions needs to have at least two items to connect"),
    ONE_CORRECT_OPTION_NEEDED("Questions need to have at least a correct option"),
    ...
    NO_PROPOSED_ANSWER("Open ended question has no proposed answer"),
