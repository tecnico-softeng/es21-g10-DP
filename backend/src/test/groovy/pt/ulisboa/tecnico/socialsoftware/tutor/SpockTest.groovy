...
class SpockTest extends Specification {
    ...
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_1 = "Item Combination Question Content 1"
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_2 = "Item Combination Question Content 2"
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_3 = "Item Combination Question Content 3"
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_4 = "Item Combination Question Content 4"
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_5 = "Item Combination Question Content 5"
    public static final String ITEM_COMBINATION_QUESTION_CONTENT_6 = "Item Combination Question Content 6"

    public static final String OPEN_ENDED_QUESTION_1_PROPOSED_ANSWER = "Open ended question 1 proposed answer"
    public static final String OPEN_ENDED_QUESTION_2_PROPOSED_ANSWER = "Open ended question 2 proposed answer"

    public static final int OPEN_ENDED_QUESTION_1_MAX_CHARS = 32
    public static final int OPEN_ENDED_QUESTION_2_MAX_CHARS = 64
